...
namespace TomCat {
	...
	void EditorUIManager::SetupImGuiStyle()
	{
	...
	void EditorUIManager::DrawMenuBar()
	{
	...
	void EditorUIManager::DrawHierarchyPanel()
	{
	...
	void EditorUIManager::DrawInspectorPanel()
	{
	...
	void EditorUIManager::DrawProjectPanel()
	{
		ImGui::Begin("Project");
	...
	void EditorUIManager::DrawConsolePanel()
	{
		ImGui::Begin("Console");
	...
	void EditorUIManager::DrawSceneSettingsPanel()
	{
	...
	void EditorUIManager::DrawViewportPanel(uint32_t textureID, const glm::vec2& viewportSize)
	{
	...
	void EditorUIManager::DrawStatusBar()
	{
		// 固定高度
	...
	void EditorUIManager::AddSceneObject(const std::string& name)
	{
	...
	void EditorUIManager::DrawSceneObjectTree(std::shared_ptr<SceneObject> obj, int depth)
	{
	...
	void EditorUIManager::SetupDockSpace()
	{
