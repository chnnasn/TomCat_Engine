...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.4.328.0/windows/vulkan_sdk.exe'
HAZEL_VULKAN_VERSION = '1.4.328.0'
VULKAN_SDK_EXE_PATH = 'TomCat/vendor/VulkanSDK/VulkanSDK.exe'
...
OutputDirectory = "TomCat/vendor/VulkanSDK"
