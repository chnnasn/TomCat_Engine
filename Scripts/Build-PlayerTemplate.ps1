...
try {
    ...
    Copy-TemplateFile -Source (Join-Path $repositoryRoot "TomCat/vendor/Assimp-build/bin/Release/assimp-vc143-mt.dll") -RelativePath "assimp-vc143-mt.dll" -Root $stagingFull
