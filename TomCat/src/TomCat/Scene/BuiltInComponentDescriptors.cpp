...
namespace TomCat {
	...
	namespace {
		...
		ComponentDescriptor MakeMeshDescriptor()
		{
			auto descriptor = BaseDescriptor<MeshComponent>(ComponentIds::MeshRenderer,
				"TomCat.MeshRenderer", "Mesh Renderer");
			...
			descriptor.Properties = {
				BoolProperty<MeshComponent>(1600, "Enabled", &MeshComponent::Enabled),
				ColorProperty<MeshComponent>(1601, "Color", &MeshComponent::Color),
