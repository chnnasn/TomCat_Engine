...
namespace TomCat {
	...
	// Engine infrastructure shaders are code, not project assets. Embedding this
	// one keeps the shipping player independent from an uncooked Packages/Shaders
	// tree before (and after) its game package is mounted.
	static constexpr const char* s_TextureVertexShader = R"(
#version 450 core
...
void main()
{
	...
	static constexpr const char* s_TextureFragmentShader = R"(
#version 450 core
...
void main()
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.TextureShader = Shader::Create("TomCat.Renderer2D.Texture",
			s_TextureVertexShader, s_TextureFragmentShader);
